                ...
                if pid:
                    ...
                    query += """
                        AND (
                            ...
                            OR (
                                D.period_id IS NULL
                                AND date(D.incident_date) BETWEEN
                                    (SELECT date(start_date) FROM AcademicPeriods WHERE id = ?)
                                    AND
                                    (SELECT date(end_date) FROM AcademicPeriods WHERE id = ?)
                            )
                        )
                    """
