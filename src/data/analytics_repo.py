...
class AnalyticsRepository:
    ...
    def get_attendance_summary_by_class(self, year_id: int) -> list:
    ...
    def get_grades_summary_by_class(self, year_id: int) -> list:
    ...
    def get_grades_for_class(self, class_id: int, year_id: int) -> list:
    ...
    def get_comprehensive_stats(self, year_id: int) -> dict:
    ...
    def get_grades_by_subject(self, year_id: int, class_id: int | None = None) -> list:
    ...
    def get_monthly_attendance_rate(self, year_id: int, class_id: int | None = None) -> list:
    ...
    def get_finance_summary(self, year_id: int, class_id: int | None = None) -> tuple:
