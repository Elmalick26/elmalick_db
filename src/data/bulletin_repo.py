...
class BulletinRepository:
    ...
    def get_period_year_id(self, period_id: int) -> int | None:
    ...
    def get_grade_score(self, student_id: int, subject_id: int, assessment_id: int, year_id: int) -> float:
    ...
    def get_attendance_count(self, student_id: int, status: str, year_id: int, period_id: int | None = None) -> int:
    ...
    def get_discipline_data_raw(self, student_id: int, year_id: int, period_id: int | None = None) -> tuple:
    ...
    def get_student_details(self, student_id: int) -> tuple | None:
    ...
    def get_period_meta(self, period_id: int) -> tuple | None:
